...
- Sprint AH Intelligence KPIs and Fontana Diagnostic Report are local read-only work; ClaudeCode review is required before any deployment.
- Sprint AI Research Command Center and Deployment Verification Checklist are local frontend/docs work; ClaudeCode review is required before any deployment.
- Sprint AJ Official Source Finder is local read-only backend/frontend/docs work; ClaudeCode review is required before any deployment.
...
`SEC EDGAR cron -> SpecialSituation -> Kanban -> Official Source Finder -> Missing Evidence Hunter / Case Documentation Guide -> Case Activity Timeline -> checklist/resources -> evidence mapping -> manual ResearchCase promotion -> Research Timeline -> Evaluation Preparation -> Evidence Links -> Intelligence Score -> Intelligence KPIs -> Fontana Diagnostic Report -> manual review`
