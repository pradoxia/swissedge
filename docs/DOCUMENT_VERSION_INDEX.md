...
| Product Roadmap | `docs/product/ROADMAP.md` | 0.5.3 | active | Dani | true | 2026-06-10 | MVP v3 M1-M6 sprint sequence, implemented scheduled detection, M1 document body acquisition, M3A Research Inbox foundation, and M4A price context foundation status, superseded governance-first candidates, and post-MVP roadmap. |
...
| Data Model | `docs/architecture/DATA_MODEL.md` | 0.2.1 | active | Dani | true | 2026-06-10 | Current and deferred domain/entity model, including M1 `ResearchDocument` body text fields and M4A price context tables. |
...
| API Specification | `docs/engineering/API_SPECIFICATION.md` | 0.1.1 | active | Dani | true | 2026-06-10 | High-level official API map, including Research Inbox optional price context shape. |
| Operations Runbook | `docs/operations/RUNBOOK.md` | 0.4.4 | active | Dani | true | 2026-06-10 | Safe daily operations, scheduled detection checks, manual SEC body acquisition rules, AI client hardening, Analyze Case preview observability, Research Inbox and price context guardrails, and guarded action rules. |
