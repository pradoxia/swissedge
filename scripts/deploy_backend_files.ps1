...
$backendFiles = @(
    ...
    "backend/services/investment/auto_acquisition.py",
    "backend/services/investment/study_guide.py",
    "backend/services/investment/price_context.py",
    ...
    "backend/db/migrations/versions/j0e1f2g3h4i5_add_decision_records.py backend/db/migrations/versions/k1f2g3h4i5j6_add_research_document_situation_link.py",
    "requirements.txt"
)
